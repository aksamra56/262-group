<template> 
  <body class="bg-blue-100">
    <nav class="relative px-4 py-4 flex justify-between items-center bg-white">
      ...
      <a class="hidden lg:inline-block py-2 px-6 bg-orange-400 hover:bg-orange-600 text-sm text-white font-bold rounded-xl transition duration-200" href="#">Sign up</a>
    </nav>
